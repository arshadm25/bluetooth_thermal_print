...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> getBluetooth() async {
    final List? bluetooths = await BluetoothThermalPrint.getBluetooths;
  ...
  Future<void> setConnect(String mac) async {
    final String? result = await BluetoothThermalPrint.connect(mac);
  ...
  Future<void> printTicket() async {
    String? isConnected = await BluetoothThermalPrint.connectionStatus;
    if (isConnected == "true") {
      List<int> bytes = await getTicket();
      final result = await BluetoothThermalPrint.writeBytes(bytes);
      print("Print $result");
    } else {
