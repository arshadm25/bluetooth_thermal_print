package ecogo.plugins.bluetooth_thermal_print
...
/** BluetoothThermalPrintPlugin */
class BluetoothThermalPrintPlugin: FlutterPlugin, MethodCallHandler {
  ...
  override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "bluetooth_thermal_print")
